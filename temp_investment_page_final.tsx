...
export default function InvestmentDetail(\{ params \}: \{ params: Promise<\{ id: string \}> \}) \{`r`n  const BACKEND_URL = process.env.NEXT_PUBLIC_BACKEND_URL \|\| ''http://localhost:3001'';
